...
* [`src/cljs/samples/`](src/cljs/samples/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/samples/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `samples` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/samples/config.cljs) defaults to `true` in
...
```clj
(ns samples.example
  (:require [samples.config :as config])
